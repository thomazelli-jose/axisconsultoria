...
export const Cases = () => {
  ...
  return <section className="py-20 bg-gradient-steel">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cases.map((caseItem, index) => <div key={index} className="bg-white rounded-lg shadow-steel hover:shadow-industrial transition-all duration-300 overflow-hidden group">
              {/* Header */}
              ...
              <div className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div className={`h-2 rounded-full ${caseItem.color.replace('bg-', 'bg-')} transition-all duration-1000 group-hover:w-full`} style={{
