            ...
            <Card className="shadow-steel border-industrial-light">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-industrial-steel">jose.thomazelli@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Phone className="w-5 h-5 text-industrial-blue" />
                  <span className="text-industrial-steel">(17) 98833-2566</span>
                </div>
                    ...
                    <form onSubmit={handleConsultancySubmit} className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input type="text" required value={consultancyForm.name} onChange={e => setConsultancyForm({
                          ...consultancyForm,
                          name: e.target.value
                        ...
                        <div>
                          ...
                          <Input type="text" required value={consultancyForm.company} onChange={e => setConsultancyForm({
                          ...consultancyForm,
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input type="email" required value={consultancyForm.email} onChange={e => setConsultancyForm({
                          ...consultancyForm,
                        ...
                        <div>
                          ...
                          <Input type="tel" placeholder="(00) 00000-0000" value={consultancyForm.phone} onChange={e => handlePhoneChange(e.target.value, 'consultancy')} className="border-industrial-light focus:border-industrial-blue" />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <Textarea required rows={4} value={consultancyForm.message} onChange={e => setConsultancyForm({
                        ...consultancyForm,
                        message: e.target.value
                      })} placeholder="Conte-nos sobre os desafios da sua empresa e como podemos ajudar..." className="border-industrial-light focus:border-industrial-blue" />
                      </div>
                    ...
                    <form onSubmit={handleTrainingSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input type="text" required value={trainingForm.name} onChange={e => setTrainingForm({
                          ...trainingForm,
                          name: e.target.value
                        })} className="border-industrial-light focus:border-industrial-blue" />
                        </div>
                        <div>
                          ...
                          <Input type="text" required value={trainingForm.company} onChange={e => setTrainingForm({
                          ...trainingForm,
                          company: e.target.value
                        })} className="border-industrial-light focus:border-industrial-blue" />
                        </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input type="email" required value={trainingForm.email} onChange={e => setTrainingForm({
                          ...trainingForm,
                          email: e.target.value
                        })} className="border-industrial-light focus:border-industrial-blue" />
                        </div>
                        <div>
                          ...
                          <Input type="tel" placeholder="(00) 00000-0000" value={trainingForm.phone} onChange={e => handlePhoneChange(e.target.value, 'training')} className="border-industrial-light focus:border-industrial-blue" />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <select required value={trainingForm.trainingType} onChange={e => setTrainingForm({
                          ...trainingForm,
                        ...
                        <div>
                          ...
                          <Input type="date" value={trainingForm.date} onChange={e => setTrainingForm({
                          ...trainingForm,
                          date: e.target.value
                        })} className="border-industrial-light focus:border-industrial-blue" />
                        </div>
                      ...
                      <div>
                        ...
                        <Input type="number" min="1" value={trainingForm.participants} onChange={e => setTrainingForm({
                        ...trainingForm,
                        participants: e.target.value
                      })} placeholder="Quantas pessoas participarão?" className="border-industrial-light focus:border-industrial-blue" />
                      </div>
